...
class BMP_Install
{
  ...
  UNIQUE(child_id)
    ...
    {
        $action_links = array(
            'settings' => '<a href="' . admin_url('admin.php?page=bmp-settings') . '" aria-label="' . esc_attr__('View Binary MLM Plan settings', 'bmp') . '">' . esc_html__('Settings', 'bmp') . '</a>',
        );
    ...
    public static function insert_table_data()
    {
        ...
        $insert = "INSERT INTO {$wpdb->prefix}bmp_country (`id`, `iso`, `name`, `iso3`, `numcode`) VALUES
        ...
        $insert = "INSERT INTO {$wpdb->prefix}bmp_currency (`id`, `iso3`, `symbol`, `currency`) VALUES
    ...
    public static function get_pages_array()
    {
        return apply_filters(
            ...
            array(
                'register'      => array(
                    'name'    => _x('Register', 'Page slug', 'bmp'),
                    'title'   => _x('Register', 'Page title', 'bmp'),
                    'content' => '',
                ),
                'join-network'      => array(
                    'name'    => _x('Join Network', 'Page slug', 'bmp'),
                    'title'   => _x('Join Network', 'Page title', 'bmp'),
                    'content' => '',
                ),
                'downlines'      => array(
                    'name'    => _x('Downlines', 'Page slug', 'bmp'),
                    'title'   => _x('Downlines', 'Page title', 'bmp'),
                    'content' => '',
                ),
                'bmp-acccount-detail'      => array(
                    'name'    => _x('Bmp Account Detail', 'Page slug', 'bmp'),
                    'title'   => _x('Bmp Account Detail', 'Page title', 'bmp'),
                    'content' => '',
                ),
    ...
    public static function create_pages()
    {
        ...
        //     "name" => __('Binary MLM Plan'),
        //     'title' => __('Binary MLM Plan')
        // );
        ...
        //         0,
        //         array(
        //             'menu-item-title' =>  __('Binary MLM Plan'),
        //             'menu-item-classes' => 'bmp',
        ...
        //     update_post_meta($parent_id, 'menu_item_bmp', 'bmp');
        // } else {
        ...
        foreach ($pages as $key => $page) {
            ...
            // if (empty($page_id)) {
            $pageid = bmp_create_page(esc_sql($page['name']), 'bmp_' . $key . '_page_id', $page['title'], $page['content'], !empty($page['parent']) ? bmp_get_page_id($page['parent']) : '');
